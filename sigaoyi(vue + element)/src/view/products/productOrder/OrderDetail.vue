      ...
      <div class="compile">
          ...
          <div class="orderLeft">
            <div class="orderStatus">
              ...
              <select
                ...
                v-model="optionIndex"
                @change="changeSet(optionsList, optionIndex)"
              >
                <option
          ...
          <div class="productInfoLeft">
            ...
            <div class="Info InfoSelect">
              ...
              <div>
                <select
                  class="purchaseType"
                  v-model="purchaseIndex"
                  @change="changeSet(purchaseType, purchaseIndex)"
                >
                  <option
                    v-for="(item, index) in purchaseType"
                    :key="index"
                    :value="index"
                    :selected="item.selected"
                  >
        ...
        <div class="logisticsInfoDetial">
            ...
            <div class="Info selectInfo">
              ...
              <div>
                <select
                  ...
                  @change="changeSet(countryList, countryIndex)"
                >
                  <option
            ...
            <div class="Info selectInfo">
              ...
              <div>
                <select
                  ...
                  @change="changeSet(tradeTypeList, tradeIndex, '5')"
                >
                  <option
          ...
          <div class="logisticsInfoRight">
            <div class="Info active">
              <div>长*宽*高(cm)<i class="mustIcon">*</i></div>
              <div>
                <input
                  type="text"
            ...
            <div class="Info">
              <div>英文名<i class="mustIcon">*</i></div>
              <div>
                <input
                  type="text"
                  placeholder="必须填"
            ...
            >
              ...
              <div>
                <select
                  ...
                  @change="changeSet(channelList, channelIndex, '5')"
                >
                  <option
  ...
  data() {
    return {
      ...
      optionsList: [
        ...
        { name: "已完成", value: 3, selected: false },
      ...
      countryIndex: 0,
      countryList: [
        { name: "日本", value: "JP", selected: true },
        { name: "菲律宾", value: "1", selected: false },
        { name: "美国", value: "2", selected: false },
        { name: "英国", value: "3", selected: false },
      ],
      //   采购方式
      purchaseIndex: 0,
      purchaseType: [
        { name: "自采购", value: 0, selected: true },
        { name: "待采购", value: 1, selected: false },
      ],
      // 发货渠道
      channelIndex: 0,
      channelList: [
    ...
    if (this.$route.query.rowStatus) {
      ...
      if (
        ...
        if (this.InfoData.statu == "5") {
          this.tradeTypeList.forEach((e, i) => {
            e.selected = false;
            if (e.value == "QDMP") {
              this.tradeIndex = i;
              e.selected = true;
  ...
  methods: {
    ...
    getList(id) {
      ...
      this.$axios({
        ...
        .then((result) => {
          ...
          if (result.data.Code == 200) {
            if (result.data.logistics.order_id == "null") {
              result.data.logistics.order_id = "";
            }
            if (result.data.logistics.orderId == "null") {
              result.data.logistics.orderId = "";
            }
    ...
    getPurchaseType() {
      ...
      for (let i = 0; i < this.optionsList.length; i++) {
        ...
        if (this.optionsList[i].value == this.row.status) {
      ...
      for (let i = 0; i < this.purchaseType.length; i++) {
        this.purchaseType[i].selected = false;
        if (this.row.purchaseMode == this.purchaseType[i].value) {
          this.purchaseType[i].selected = true;
      ...
      for (let i = 0; i < this.tradeTypeList.length; i++) {
        this.tradeTypeList[i].selected = false;
        if (this.row.trade_type == this.tradeTypeList[i].value) {
          this.tradeTypeList[i].selected = true;
          this.tradeIndex = i;
        }
      }
      ...
      for (let i = 0; i < this.channelList.length; i++) {
        this.channelList[i].selected = false;
        if (this.row.trade_type1 == this.channelList[i].value) {
          this.channelList[i].selected = true;
          this.channelIndex = i;
        }
      }
    ...
    plan(flag) {
      ...
      // 运输方式
      for (let i = 0; i < this.tradeTypeList.length; i++) {
        if (this.tradeTypeList[i].selected) {
          data.trade_type = this.tradeTypeList[i].value;
        }
      }

      // 发货渠道
      for (let i = 0; i < this.channelList.length; i++) {
        if (this.channelList[i].selected) {
          data.trade_type1 = this.channelList[i].value;
        }
      }
    ...
    AddOrder() {
      ...
      if (this.$route.query.rowStatus) {
        ...
        var data = {
          ...
          trade_type1: this.row.trade_type1,
        ...
        for (let i = 0; i < this.purchaseType.length; i++) {
          if (this.purchaseType[i].selected) {
            data.purchaseMode = this.purchaseType[i].value;
          }
        }
        // 运输方式
        for (let i = 0; i < this.tradeTypeList.length; i++) {
