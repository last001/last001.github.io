<template>
  <el-checkbox-group v-model="data.modelValue" @change="handler('radioChange', $event, null)">
    <el-checkbox v-for="item in data.options" :key="item.value" :label="item.value">{{ item.text }}</el-checkbox>
  </el-checkbox-group>
</template>
