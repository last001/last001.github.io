<template>
  <el-radio-group v-model="data.modelValue" @change="handler('radioChange',$event,null)">
    <el-radio v-for="item in data.options" :key="item.value" :label="item.value">{{item.text}}</el-radio>
  </el-radio-group>
</template>
