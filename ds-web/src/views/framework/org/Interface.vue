          ...
          <el-form ref="formRef" :model="formData" :rules="formRules" label-width="auto" label-position="left">
            <el-row :gutter="20">
             ...
             <el-row :gutter="20">
              ...
              <el-input class=""  maxlength="20" show-word-limit v-model="formData.name"/>
            </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="接口描述" prop="description" required>
                  <el-input class="" maxlength="20" show-word-limit v-model="formData.description"/>
                </el-form-item>
              </el-col>
            </el-row>
...
const tableBarData = {
  queryMetaPageFun:dsmain.getInterfaceMetaPage,
  filterBar:[
    {name:"微服务名",type:"dropselect",field:"inputSearch",defaultValue:"",filters:[
        {field:"serviceName",expression:"$regex"},
      ]},
