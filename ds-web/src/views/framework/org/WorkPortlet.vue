  ...
  <div class="ds-wrapper org-wrapper">
    ...
    <div class="mt-20 bg-white" v-if="!hidden" style="height: 100%">
      <el-row class="ml-10 mr-10 mt-20" :gutter="14">
        <el-col :span="3" v-for="item in arr" :key="item">
          <el-card
      ...
      <template #default>
        <el-scrollbar>
          ...
          >
            ...
            <el-row>
              <el-col :span="24">
                <el-form-item label="组件链接" prop="link" required>
                  <el-input
                    type="number"
                    class=""
            ...
            <el-row :gutter="24">
              <el-col :span="24">
                <el-form-item label="应用范围" prop="range" required>
                  <el-checkbox v-for="item in 3" :key="item">ALL</el-checkbox>
                </el-form-item>
              </el-col>
            </el-row>
          </el-form>
...
export default {
  name: "Portlet",
  path: "/framework/org/workportlet",
};
</script>
