            ...
            <el-row :gutter="20">
              ...
              <el-col :span="12">
                <el-form-item label="所属机构" prop="orgId" required>
                  <ds-select class="w-full" v-model="formData.orgId" placeholder="请选择机构" data-source="Model" data-source-key="ds_org" text-field="name" value-field="id"></ds-select>
                </el-form-item>
              </el-col>
            </el-row>
            <el-row :gutter="20">
              ...
              <el-col :span="12">
                <el-form-item label="管理员类型" prop="adminType">
                  <el-radio-group v-model="formData.adminType">
                    <el-radio-button label="Operate" checked>
                      运维人员
                    </el-radio-button>
                    <el-radio-button label="OrgSuperAdmin">
                      超级管理员
                    </el-radio-button>
                  </el-radio-group>
                </el-form-item>
...
export default {
  name:"User",
  path: "/framework/org/user4employee"
}
</script>
...
const tableData = {
  ...
  filters:[{key: "adminType", data: {$in: ['Operate','OrgSuperAdmin']},}],
