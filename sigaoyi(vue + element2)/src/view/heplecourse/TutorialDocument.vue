        ...
        <div class="sreach">
          ...
          <div class="btn">
            <el-button type="default" size="small" @click="reset()"
              >重置</el-button
            >
            <el-button type="primary" size="small" @click="searchInput(1, 30)"
              >搜索</el-button
            >
          </div>
        </div>
        <div class="table">
          <div class="v-table">
            <div class="updataFile">
              ...
              <span class="relaod" @click="getList()">
...
export default {
  ...
  methods: {
      ...
      this.$axios({
        ...
        .then((result) => {
          ...
          if (result.data.Code == 200) {
            ...
            if (result.data.grouptables.length > 0) {
              this.optionIndex = result.data.grouptables[0].id;
            }
          } else {
            this.$notify({
              title: "请求失败",
    ...
    handleSizeChange(val) {
      this.pageSize = val;
      this.searchInput(this.currentPage, this.pageSize);
    },
    // 去第几页
    ...
    updataFile(e) {
      ...
      formData.append("mulv", this.optionIndex);
