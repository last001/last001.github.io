...
export const routes = [
  ...
  // 产品订单
  {
    ...
    children: [{
        path: 'qutianOrder',
        name: 'QutianOrder',
        component: () => import('../view/products/productOrder/qutianOrder.vue'),
        meta: {
          keepAlive: true,
          isBack: false,
        },
  ...
  // 物流管理  Logistics
  {
    ...
    children: [{
        path: 'logisticsOrder',
        name: 'LogisticsOrder',
        component: () => import('../view/logistics/LogisticsOrder.vue'),
        meta: {
          keepAlive: true,
          isBack: false,
        },
      },
      {
        ...
        component: () => import('../view/logistics/LogisticsChannel.vue'),
        meta: {
          keepAlive: false,
          isBack: false,
        },
      },
      {
        path: 'orderDetail',
        name: 'OrderDetail',
        component: () => import('../view/logistics/OrderDetail.vue'),
        meta: {
          keepAlive: false,
          isBack: false,
        },
  ...
  // 财务管理
  {
    ...
    children: [{
      ...
      },
      {
        path: 'profitCensus',
        name: 'ProfitCensus',
        component: () => import('../view/consumption/ProfitCensus.vue')
      },
      {
        path: 'datAnalysis',
        name: 'DatAnalysis',
        component: () => import('../view/consumption/DatAnalysis.vue')
      },
    ]
  },
  // 帮助教学
  {
    ...
    children: [{
      ...
      },
      {
        ...
        component: () => import('../view/heplecourse/FreightComputers.vue')
      },
      {
        path: 'imageOnlineURL',
        name: 'ImageOnlineURL',
        component: () => import('../view/heplecourse/imageOnlineURL.vue')
      },
    ]
  },
  // 系统管理
